...
http1Router.on('GET', '/test', { version: '2.0.0' }, (req, res) => res.end(req.url));
http1Router.on('GET', '/test', (req, res) => res.end(req.url), { foo: 'bar' });
http1Router.on(['POST', 'PUT'], '/test', { version: '1.0.0' }, (req, res) => res.end(req.url), { foo: 'bar' });
http1Router.delete('/item/:id', (req, res, params, store) => {
    const id = params.id;
    res.end(`
    url: ${req.url || '-'},
    id: ${id || '-'},
...
http2Router.on('GET', '/test', { version: '2.0.0' }, (req, res) => res.end(req.url));
http2Router.on('GET', '/test', (req, res) => res.end(req.url), { foo: 'bar' });
http2Router.on(['POST', 'PUT'], '/test', { version: '1.0.0' }, (req, res) => res.end(req.url), { foo: 'bar' });
http2Router.delete('/item/:id', (req, res, params, store) => {
    const id = params.id;
    res.end(`
    url: ${req.url || '-'},
    id: ${id || '-'},
