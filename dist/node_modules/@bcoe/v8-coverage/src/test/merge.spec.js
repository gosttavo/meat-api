        ...
        for (const sourceFile of getSourceFiles()) {
            ...
            describe(relPath, () => {
                ...
                for (const item of items) {
                    const test = () => {
                        const actual = lib_1.mergeProcessCovs(item.inputs);
        ...
        for (const bench of getBenches()) {
            ...
            function testBench() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const inputFileNames = yield fs_1.default.promises.readdir(bench);
                    const inputPromises = [];
                    ...
                    const expectedContent = yield fs_1.default.promises.readFile(expectedPath, { encoding: "UTF-8" });
